...
export const useAdmin = () => {
    ...
    const login = async (admin: AdminType) => {
        ...
        const response:AxiosResponse = await axios.post(REACT_APP_BACKEND_URL + "/admin/login", admin);
    ...
    const getAdmin = async () => {
        try {
            const response: AxiosResponse = await axios.get(REACT_APP_BACKEND_URL + "/admin");
    ...
    const getRegisterAdmin = async (): Promise<AxiosResponse<string, string>> => {
        try {
            const response: AxiosResponse<string, string> = await axios.get(REACT_APP_BACKEND_URL + "/admin");
            return response;
        } catch (error) {
            alert(`エラーが発生しました${error}`);
            throw error;
    ...
    const updateAdmin = async (updateData: AdminType): Promise<AxiosResponse<string, string>> => {
        try {
            const response: AxiosResponse<string, string> = await axios.put(REACT_APP_BACKEND_URL + "/admin/update", updateData);
            return response;
        } catch (error) {
            alert(`エラーが発生しました${error}`);
            throw error;
